...
module.exports = {
    post_sensor: async function (req, res, next) {
        try {
    ...
    get_sensor: async function (req, res, next) {
        try {
            const db = await connectToMongoDB();
            const collectionName = process.env.SENSOR_COLLECTION;
    ...
    get_sensor_ID: async function (req, res, next) {
        try {
            const db = await connectToMongoDB();
            const CollectionName = process.env.SENSOR_COLLECTION;
    ...
    attribute_mapping: async function (req, res, next) {
        try {
          const db = await connectToMongoDB();
