...
module.exports = {
  ...
  odt_mapping: async function (req, res, next) {
    try {
  ...
  get_odt: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
  ...
  value_odt_mapping: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
  ...
  value_odt_mapping_Id: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
      const eventCollectionName = process.env.EVENT_COLLECTION;
      const odtCollectionName = process.env.ODT_COLLECTION;
  ...
  page_odt_mapping: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
      const eventCollectionName = process.env.EVENT_COLLECTION;
      const odtCollectionName = process.env.ODT_COLLECTION;
  ...
  // entity_form_mapping
  entity_form_mapping: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
      const eventCollectionName = process.env.EVENT_COLLECTION;
      const odtCollectionName = process.env.ODT_COLLECTION;
  ...
  // report_form_mapping
  report_form_mapping: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
      const eventCollectionName = process.env.EVENT_COLLECTION;
      const odtCollectionName = process.env.ODT_COLLECTION;
  ...
  get_page_attributes: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
  ...
  update_odt_emitterId: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
      const odtCollectionName = process.env.ODT_COLLECTION;
  ...
  entity_mapping: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
      const attributeCollectionName = process.env.ATTRIBUTE_COLLECTION;
