...
module.exports = {
    post_flag: async function (req, res, next) {
        try {
    ...
    validate_Flag: async function (req, res, next) {
        try {
            const db = await connectToMongoDB();
            const collectionName = process.env.FLAG_COLLECTION;
    ...
    get_flag: async function (req, res, next){
        try {
            const db = await connectToMongoDB();
            const collectionName = process.env.FLAG_COLLECTION;
    ...
    update_flag: async function (req, res, next) {
        try {
