...
module.exports = {
  post_users: async function (req, res, next) {
    try {
  ...
  get_user_ID: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
  ...
  update_users: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
      const CollectionName = process.env.USERS_COLLECTION;
  ...
  get_users_app: async function (req, res, next) {
    try {
      const db = await connectToMongoDB();
